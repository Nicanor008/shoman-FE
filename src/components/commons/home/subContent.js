...
export const PathSubContent = () => {
  return <p>
      Be immersed into the world of design interaction, visual design, art in order to come up with the best UI.
       Understand what it takes to be a world class FrontEnd Engineer. 
  </p>
}
