      ...
      <Grid item md={4}>
        <ListData
          ...
          data={[
            ...
            { content: "JavaScript(Vanilla JS) - From syntax to Functional & OOP javascript programming" },
            { content: "Fetch API - http(s) call" },
            { content: "ES6 JS code - Async/await, arrow functions, hoisting, closures" },
            { content: "Test Driven Development - Mocha, Chai, Jest, Jasmine, etc" },
            { content: "Framework/library(optional) - React (for now) (learning a framework/library is and will not be our goal, but at the end you'll be doing awesome stuff in ReactJS)" },
          ]}
        />
      </Grid>
      <Grid item md={4}>
        <ListData
          ...
          data={[
            ...
            { content: "Weather App - Perfect your JS & CSS skills while using Fetch API" },
            { content: "Meet up Planner - Management various meet ups - Combination of all skills" },
